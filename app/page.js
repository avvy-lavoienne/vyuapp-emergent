...
// --- Pure presentational sub-components (Server Components) ---
...
async function HomeContent({ locale }) {
  ...
  return (
    <main>
      <Navbar />
      {/* Hero is now a Server Component — h2 renders server-side for instant LCP */}
      <Hero locale={locale} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              {/* ContactForm is a Client Component — takes locale prop, no context needed */}
...
// --- Server Component: reads locale from cookie, wraps client components with LocaleProvider ---
