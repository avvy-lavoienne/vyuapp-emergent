    ...
    <main className="min-h-screen bg-[#FAFAF8]">
      ...
      <article className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6 md:px-10">
          <p className="font-mono text-xs text-[#6D5BA0] uppercase tracking-[0.15em] font-medium">Tentang Kami</p>
          <h1 className="mt-4 text-3xl md:text-5xl font-sans font-semibold text-[#141413] tracking-[-0.02em]">
            Studio Rekayasa Web Premium dari Garut
          </h1>
          <p className="mt-5 text-lg text-[#4A4A48] leading-relaxed max-w-3xl">
          ...
          <div className="mt-16 space-y-16">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <span className="w-10 h-10 rounded-lg bg-[#6D5BA0]/10 flex items-center justify-center text-[#6D5BA0]">
                  <Code className="w-5 h-5" />
                </span>
                <h2 className="text-xl font-semibold text-[#141413]">Pengalaman & Keahlian</h2>
              </div>
              <div className="text-[#4A4A48] text-sm leading-relaxed space-y-3">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold text-[#141413]">Filosofi Kerja</h2>
              </div>
              <div className="text-[#4A4A48] text-sm leading-relaxed space-y-3">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold text-[#141413]">Kapasitas & Kontak</h2>
              </div>
              <div className="text-[#4A4A48] text-sm leading-relaxed space-y-3">
                ...
                <div className="flex items-center gap-3 mt-4">
                  <Mail className="w-4 h-4 text-[#6D5BA0]" />
                  <a href="mailto:vyuapp@proton.me" className="text-[#6D5BA0] hover:text-[#574886]">vyuapp@proton.me</a>
                </div>
                <div className="flex items-center gap-3">
                  <Globe className="w-4 h-4 text-[#6D5BA0]" />
                  <a href="https://github.com/avvy-lavoienne" target="_blank" rel="noopener noreferrer" className="text-[#6D5BA0] hover:text-[#574886]">GitHub</a>
                </div>
              </div>
            </section>
          </div>
