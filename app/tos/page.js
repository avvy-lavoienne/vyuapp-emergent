    ...
    <main className="min-h-screen bg-[#FAFAF8]">
      ...
      <article className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6 md:px-10">
          <p className="font-mono text-xs text-[#6D5BA0] uppercase tracking-[0.15em] font-medium">Legal</p>
          ...
          <div className="mt-10 space-y-8 text-[#4A4A48] text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">1. Penerimaan Syarat</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">2. Layanan</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">3. Hak Kekayaan Intelektual</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">4. Pembayaran dan Pembatalan</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">5. Pembatasan Tanggung Jawab</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">6. Privasi</h2>
              <p>Pengumpulan dan penggunaan data pribadi Anda diatur dalam <a href="/privacy" className="text-[#6D5BA0] hover:text-[#574886]">Kebijakan Privasi</a> kami. Dengan menggunakan layanan VyuApp, Anda juga menyetujui ketentuan privasi yang berlaku.</p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">7. Perubahan Syarat</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">8. Kontak</h2>
              ...
              Email: <a href="mailto:vyuapp@proton.me" className="text-[#6D5BA0] hover:text-[#574886]">vyuapp@proton.me</a></p>
            </section>
          </div>
        </div>
      </article>
