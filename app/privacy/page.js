      ...
      <article className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6 md:px-10">
          ...
          <div className="mt-10 space-y-8 text-[#4A4A48] text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">1. Pengumpulan Informasi</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">2. Penggunaan Informasi</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">3. Penyimpanan Data</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">4. Cookie</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">5. Hak Anda</h2>
              <p>Anda berhak untuk meminta akses, perubahan, atau penghapusan data pribadi Anda. Untuk pertanyaan terkait privasi, hubungi kami di <a href="mailto:vyuapp@proton.me" className="text-[#6D5BA0] hover:text-[#574886]">vyuapp@proton.me</a>.</p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[#141413] mb-3">6. Kontak</h2>
