...
function Capability({ title, description }) {
  return (
    <div className="p-8 md:p-10 rounded-2xl border border-[#d2d2d7] dark:border-[#333336] bg-white dark:bg-[#1d1d1f] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#D1D0C9] dark:hover:border-[#3A3A3D]">
...
function ProductCard({ name, tagline, description, features, href, ctaLabel }) {
  ...
  return (
    <div className="p-8 md:p-10 rounded-2xl border border-[#d2d2d7] dark:border-[#333336] bg-white dark:bg-[#1d1d1f] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#D1D0C9] dark:hover:border-[#3A3A3D] flex flex-col">
...
function PhilosophyItem({ title, description }) {
  return (
    <div className="p-8 rounded-2xl border border-[#d2d2d7] dark:border-[#333336] bg-white dark:bg-[#1d1d1f] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#D1D0C9] dark:hover:border-[#3A3A3D]">
      ...
      <section className="py-24 md:py-32" id="cara-kerja">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl border border-[#d2d2d7] dark:border-[#333336] bg-white dark:bg-[#1d1d1f] text-center">
              <div className="w-12 h-12 rounded-xl bg-[#2997ff]/10 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-5 gap-5">
            {[
              ...
              <div
                ...
                className="p-6 rounded-2xl border border-[#d2d2d7] dark:border-[#333336] bg-white dark:bg-[#1d1d1f] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#D1D0C9] dark:hover:border-[#3A3A3D]"
              >
      ...
      <section className="py-24 md:py-32" id="portfolio">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-transparent text-[#1d1d1f] dark:text-[#f5f5f7] font-semibold text-sm border border-[#D1D0C9] hover:border-[#B0AFAA] hover:bg-black/[0.02] transition-all duration-200 hover:-translate-y-0.5 shrink-0 self-start md:self-auto"
            >
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 space-y-4 text-sm">
                <div className="flex items-center gap-3 text-[#4A4A48] dark:text-[#86868b]">
                  <span className="w-9 h-9 rounded-lg bg-white dark:bg-[#1d1d1f] border border-[#d2d2d7] dark:border-[#333336] flex items-center justify-center text-[#2997ff]">
                  ...
                  <a href="mailto:vyuapp@proton.me" className="hover:text-[#2997ff] transition-colors">vyuapp@proton.me</a>
                </div>
                <div className="flex items-center gap-3 text-[#4A4A48] dark:text-[#86868b]">
                  <span className="w-9 h-9 rounded-lg bg-white dark:bg-[#1d1d1f] border border-[#d2d2d7] dark:border-[#333336] flex items-center justify-center text-[#2997ff]">
